...
class Captainform {
	...
	private function define_general_hooks() {
		...
		if ($php_version >= 5.3) {
            ...
            // phpcs:disable WordPress.PHP.RestrictedPHPFunctions.create_function_create_function
			add_action(
				'widgets_init',
				create_function('', 'return register_widget("Captainform_Widget");')
			);
            // phpcs:enable WordPress.PHP.RestrictedPHPFunctions.create_function_create_function
		}
